...
export function PrivacyModal({ isOpen, onClose, selectedLanguage }: PrivacyModalProps) {
  ...
  return (
    <div 
      className="fixed inset-0 bg-black bg-opacity-50 backdrop-blur-sm flex items-center justify-center p-4 z-50 transition-all duration-300"
      onClick={(e) => e.target === e.currentTarget && onClose()}
    >
      <div className="glass-effect rounded-3xl max-w-2xl w-full max-h-[80vh] overflow-hidden animate-fadeIn">
